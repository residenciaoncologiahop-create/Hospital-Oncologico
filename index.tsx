                                                ...
                                                <div className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                                    <div className="flex justify-between items-start mb-1">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <button onClick={() => { if(confirm('Borrar?')) { const n = [...timeline]; n.splice(i,1); setTimeline(n); savePatient({timeline:n}); }}} className="opacity-0 group-hover:opacity-100 text-gray-300 hover:text-red-500"><Trash2 size={10}/></button>
                                                        </div>
                                                    </div>
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl">
                        ...
                        <div className="space-y-3">
                            ...
                            <button onClick={async () => {
                                ...
                                await addDoc(collection(db, "patients"), { doctorId: doctorName, name: newPatientName, age: Number(newPatientAge), diagnosis: newPatientDiagnosis, lastUpdated: Date.now(), historyText:'', timeline: [], biomarkers: [], chatHistory: [] });
